...
- Create an array for people in current reservations
- Create an array for people in waitlist
    - If someone makes a reservation and there are less than 5 people on the current reservations, add them to current reservations
    - Else, add them to waitlist

* Create a set of routes for getting and posting table data
- Get /api/tables sends array of JSON objects for current tables
- Get /api/waitlist sends array of JSON objects for people on waitlist
- Post /api/tables adds new table to current tables
- Post /api/waitlist adds new table to waitlist

* Create a set of routes for displaying the HTML pages
- Get / homepage, just sends index.html
- Get /reserve sends html file to make a reservation
    - Sends information to Post /api/tables OR /api/waitlist, dependent on current table reservations
- Get /tables sends html file to view current tables and waitlist

* Use jQuery to run AJAX calls to GET and POST data from users to the Express server
- Use POST on reservation page to post table to either current reservations or waitlist
